...
#### 2. Technology 
SchoolApp is a .NET Framework web application built using Visual Studio. 
...
* Teacher Database
  ...
  * (Get) api/Teacher - This endpoint returns a list of all teachers with 
...
* Course Database
  ...
  * (Get) api/Course - This endpoint returns a list of all courses with the course id, name, and the department in which it is in.
